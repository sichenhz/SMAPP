...
#import "SMAlbumsViewController.h"
#import "SMImagePickerController.h"
#import "SMGridViewController.h"
#import "SMAlbumsViewCell.h"
#import "SMBadgeView.h"

static NSString * const SMAlbumsViewCellReuseIdentifier = @"SMAlbumsViewCellReuseIdentifier";

@interface SMAlbumsViewController()
...
@implementation SMAlbumsViewController
...
- (void)showAlbums {
    ...
    if (self.picker.sourceType == SMImagePickerControllerSourceTypeSavedPhotosAlbum ||
        self.picker.sourceType == SMImagePickerControllerSourceTypeCamera) {
...
- (void)pushCameraRollViewController {
    ...
    if (collections.count > 0) {
        ...
        SMGridViewController *cameraRollViewController = [[SMGridViewController alloc] initWithPicker:self.picker];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Dequeue an SMAlbumsViewCell.
    SMAlbumsViewCell *cell = [tableView dequeueReusableCellWithIdentifier:SMAlbumsViewCellReuseIdentifier];
    if (cell == nil) {
        cell = [[SMAlbumsViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:SMAlbumsViewCellReuseIdentifier];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SMGridViewController *gridViewController = [[SMGridViewController alloc] initWithPicker:self.picker];
