...
@interface SMImageClipViewController() <UIScrollViewDelegate>
...
@implementation SMImageClipViewController
...
- (void)viewDidLoad {
    ...
    if (!self.isPreview) {
        UIImageView *mask = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[@"SMImagePickerController.bundle" stringByAppendingPathComponent:@"photo_rule.png"]]];
